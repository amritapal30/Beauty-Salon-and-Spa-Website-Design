...
function _createClass(t, s, e) {
    return s && _defineProperties(t.prototype, s),
...
!function(e) {
    ...
    var i = {
      ...
      , e = function() {
        ...
        return _createClass(n, [{
            ...
            value: function() {
                this.pages.hide(),
                this.steps.removeClass([this.options.style.anchorDoneCss, this.options.style.anchorActiveCss]);
                var t = !(this.current_index = -1) !== (t = this._getURLHashIndex()) ? t : this.options.selected
                  , s = this._getShowable(t - 1, "forward");
                0 < (t = null === s && 0 < t ? this._getShowable(-1, "forward") : s) && this.options.anchor.enableDoneState && this.options.anchor.markPreviousStepsAsDone && this.steps.slice(0, t).addClass(this.options.style.anchorDoneCss),
                this._showStep(t),
            ...
            value: function(n) {
                ...
                0 < i.length ? i : (this._showError("Element not found " + n),
                !1))
            }
        }, {
            key: "_getDir",
            value: function() {
                ...
                return 0 === t.length && (t = document.documentElement.dir,
            ...
            value: function() {
                ...
                this.main.removeClass(function(t, s) {
                    return (s.match(new RegExp("(^|\\s)" + e.options.style.themePrefixCss + "\\S+","g")) || []).join(" ")
                ...
                !0 === this.options.anchor.enableNavigationAlways && !0 === this.options.anchor.enableNavigation || this.steps.addClass(this.options.style.anchorDefaultCss),
                l.each(this.options.disabledSteps, function(t, s) {
            ...
            value: function() {
                ...
                this.steps.on("click", function(t) {
                    var s;
                    t.preventDefault(),
                    !0 === e.options.anchor.enableNavigation && (s = l(t.currentTarget),
                    e._isShowable(s) && e._showStep(e.steps.index(s)))
                }),
                this.main.on("click", function(t) {
                    l(t.target).hasClass(e.options.style.btnNextCss) ? (t.preventDefault(),
                    e._navigate("next")) : l(t.target).hasClass(e.options.style.btnPrevCss) && (t.preventDefault(),
                    e._navigate("prev"))
                }),
                ...
                l(window).on("hashchange", function(t) {
                    var s;
                    !0 !== e.options.backButtonSupport || !1 !== (s = e._getURLHashIndex()) && e._isShowable(e.steps.eq(s)) && (t.preventDefault(),
                    e._showStep(s))
                }),
            ...
            value: function() {
                ...
                "none" !== t && ("both" == t ? (this.container.before(this._createToolbar("top")),
                this.container.after(this._createToolbar("bottom"))) : "top" == t ? this.container.before(this._createToolbar("top")) : this.container.after(this._createToolbar("bottom")))
            }
        }, {
            key: "_createToolbar",
            value: function(t) {
                var s = l("<div></div>").addClass("sw-toolbar-elm " + this.options.style.toolbarCss + " " + this.options.style.toolbarPrefixCss + t).attr("role", "toolbar")
                  , e = !1 !== this.options.toolbar.showNextButton ? l("<button></button>").text(this.options.lang.next).addClass("btn " + this.options.style.btnNextCss + " " + this.options.style.btnCss).attr("type", "button") : null
                  , n = !1 !== this.options.toolbar.showPreviousButton ? l("<button></button>").text(this.options.lang.previous).addClass("btn " + this.options.style.btnPrevCss + " " + this.options.style.btnCss).attr("type", "button") : null;
            ...
            value: function(n) {
                ...
                if (!this.steps.eq(n))
                    return !1;
                if (!this._isEnabled(this.steps.eq(n)))
                    return !1;
                var o = this._getStepDirection(n);
                if (-1 !== this.current_index && !1 === this._triggerEvent("leaveStep", [this._getStepAnchor(this.current_index), this.current_index, n, o]))
                    return !1;
                this._loadContent(n, function() {
                    var t = i._getStepAnchor(n);
                    i._setURLHash(t.attr("href")),
                    i._setAnchor(n);
                    var s = i._getStepPage(i.current_index)
                      , e = i._getStepPage(n);
                    i._transit(e, s, o, function() {
                        i._fixHeight(n),
                        i._triggerEvent("showStep", [t, n, o, i._getStepPosition(n)])
                    }),
                    i.current_index = n,
                    i._setButtons(n),
                    i._setProgressbar(n)
            ...
            value: function(t, s) {
                var e, n, i, o;
                l.isFunction(this.options.getContent) && (e = this._getStepPage(t)) ? (n = this._getStepDirection(t),
                i = this._getStepPosition(t),
                o = this._getStepAnchor(t),
                this.options.getContent(t, n, i, o, function(t) {
                    t && e.html(t),
                    s()
                })) : s()
            }
            ...
            key: "_stopAnimations",
            value: function() {
                l.isFunction(this.container.finish) && (this.pages.finish(),
            ...
            value: function(t) {
                var s;
                !1 !== this.options.autoAdjustHeight && (s = this._getStepPage(t).outerHeight(),
                l.isFunction(this.container.finish) && l.isFunction(this.container.animate) && 0 < s ? this.container.finish().animate({
                    height: s
            ...
            value: function(t) {
                var s, e;
                null !== this.current_index && 0 <= this.current_index && (s = this.options.style.anchorActiveCss,
                e = "",
                !1 !== this.options.anchor.enableDoneState && (e += this.options.style.anchorDoneCss,
                !1 !== this.options.anchor.unDoneOnBackNavigation && "backward" === this._getStepDirection(t) && (s += " " + this.options.style.anchorDoneCss)),
                this.steps.eq(this.current_index).addClass(e).removeClass(s)),
                this.steps.eq(t).removeClass(this.options.style.anchorDoneCss).addClass(this.options.style.anchorActiveCss)
            }
        }, {
            key: "_setButtons",
            value: function(t) {
                ...
                "first" === e || "last" === e ? (s = "first" === e ? "." + this.options.style.btnPrevCss : "." + this.options.style.btnNextCss,
                this.main.find(s).addClass(this.options.style.anchorDisabledCss)) : (null === this._getShowable(t, "next") && this.main.find("." + this.options.style.btnNextCss).addClass(this.options.style.anchorDisabledCss),
            ...
            value: function(t) {
                ...
                document.documentElement.style.setProperty("--sw-progress-width", e + "%"),
                0 < this.progressbar.length && this.progressbar.find("." + this.options.style.progressBarCss).css("width", e + "%")
            }
        }, {
            key: "_keyNav",
            value: function(t) {
                if (this.options.keyboard.keyNavigation)
                    if (-1 < l.inArray(t.which, this.options.keyboard.keyLeft))
                        this._navigate("prev"),
                        t.preventDefault();
                    else {
                        if (!(-1 < l.inArray(t.which, this.options.keyboard.keyRight)))
                            return;
                        this._navigate("next"),
                        t.preventDefault()
                    }
            ...
            key: "goToStep",
            value: function(t, s) {
                !0 != (s = !1 !== s) && !this._isShowable(this.steps.eq(t)) || (!0 === s && 0 < t && this.options.anchor.enableDoneState && this.options.anchor.markPreviousStepsAsDone && this.steps.slice(0, t).addClass(this.options.style.anchorDoneCss),
                this._showStep(t))
            }
        }, {
            key: "next",
            ...
            key: "reset",
            value: function() {
                this.steps.removeClass([this.options.style.anchorDoneCss, this.options.style.anchorActiveCss, this.options.style.anchorErrorCss, this.options.style.anchorWarningCss]),
                this._setURLHash("#"),
                this._init(),
                this._load()
            }
    ...
    l.fn.smartWizard = function(t) {
        ...
        if ("string" == typeof t && "_" !== t[0] && "init" !== t) {
            ...
            return "destroy" === t && l.data(this, "smartWizard", null),
            s instanceof e && "function" == typeof s[t] ? s[t].apply(s, Array.prototype.slice.call(arguments, 1)) : this
        }
    }
    ,
    l.fn.smartWizard.transitions = {
        ...
        slideHorizontal: function(t, s, e, i, n) {
            ...
            ,
            -1 == i.current_index && i.container.height(t.outerHeight()),
            a = i.container.width(),
            s && (r = s.css(["position", "left"]),
        ...
        css: function(t, s, e, n, i) {
            ...
            ,
            a = n.options.transition.prefixCss + " " + ("backward" == e ? n.options.transition.bckShowCss : n.options.transition.fwdShowCss),
            s ? (r = n.options.transition.prefixCss + " " + ("backward" == e ? n.options.transition.bckHideCss : n.options.transition.fwdHideCss),
            o(s, r, function() {
                s.hide(),
                o(t, a, function() {
                    i()
